    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-center mb-8 text-blue-600">
          Control de Inventario Spot-On
        </h1>

        <div className="max-w-3xl mx-auto text-center mb-12">
          <p className="text-xl text-gray-700">
            Spot-On ofrece una solución integral de control de inventario diseñada
        ...
        <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-xl mb-6">
            Descubre cómo Spot-On puede transformar la gestión de tu inventario y
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-center mb-8 text-blue-600">
            ¿Por qué elegir Spot-On para tu inventario?
          </h2>
